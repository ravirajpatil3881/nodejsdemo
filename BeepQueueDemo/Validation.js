//**Multiple Commits**//
//Removed unwanted code. date 07-29 
//For Testing 0824
var arrayNew=new Array();

var arrynew123=new Array();//token refresh testing #6
$(document).ready(function () {
    ...
    //Code added by Jim D
    function TFSTestJim(){
        //changeset# Multiple file commit 
        //CHECK FOR WEBHOOK #3 attempt
        var myFilePath=''
        var myFilePath3=''
        var arr = [];
    }
    ...
    function TFSTest(){
	 ...
	 function ProcessMultipleCheckIn(){
        //changeset#111
        //Test for codeJenie wehhook attempt 2  
        var v='fromCodeJenie'
        var arr = new Array();
    }
